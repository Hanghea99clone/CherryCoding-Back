...
public class ReviewController {
    ...
    public ResponseDto<String> createReview(@PathVariable Long curriculumId, @RequestBody ReviewRequestDto requestDto){
        return reviewService.createReview(curriculumId, requestDto, userDetailsService.getUser());
    }

    @PutMapping("/{reviewId}")
    @Operation(summary = "댓글 수정")
    public ResponseDto<String> updateReview(@PathVariable Long reviewId, @RequestBody ReviewRequestDto requestDto){
        return reviewService.updateReview(reviewId, requestDto, userDetailsService.getUser());
    }

    @DeleteMapping("/{reviewId}")
    @Operation(summary = "댓글 삭제")
    public ResponseDto<String> deleteReview(@PathVariable Long reviewId){
        return reviewService.deleteReview(reviewId, userDetailsService.getUser());
    }
}
